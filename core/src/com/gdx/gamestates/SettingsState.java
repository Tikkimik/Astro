...
public class SettingsState extends GameState {
    ...
    private String[] settingsItems = {"FPS: " + MyGdxGame.targetFPS, "BACK"};
    ...
    public void update(float dt) {
        ...
        // Обновляем текст FPS
        settingsItems[0] = "FPS: " + (MyGdxGame.targetFPS == 0 ? "UNLIMITED" : MyGdxGame.targetFPS);
    }
    ...
    public void draw() {
        ...
        String hint2 = "FPS settings: ← → to change, ESC to return";
    ...
    public void handleInput() {
        ...
        // Управление FPS в настройках
        if (selectedItem == 0) { // FPS настройка
